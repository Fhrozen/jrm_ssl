...
class Network(chainer.Chain):
    def __init__(self, InitOpt):
        ...
        super(Network, self).__init__(
            ...
            conv6 = L.Convolution2D(256,512,ksize=(27,2), nobias=True),
            bn6 = L.BatchNormalization(512),
            ip1 = L.Linear(4096, 2048),
            ip2 = L.Linear(2048, InitOpt[1]),
        )
        self.train=True
    ...
    def encode(self,h,printing = False):
        ...
        if printing: print 'conv6',h.data.shape
        h = self.act(self.ip1(h))
        h = self.ip2(h)
        return h
